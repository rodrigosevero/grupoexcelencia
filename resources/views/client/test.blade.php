...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <!-- <div class="card">
                <div class="card-header">Simulado - Arrais amador</div> -->
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('client.test.store') }}">
                    ...
                    <p>
                    <h1>Simulado - Arrais amador.</h1>
                    <h3>Apenas uma alternativa esta correta</h3>
                    </p>
                    <?php $i = 1; ?>
                    @csrf
                    @foreach($categories as $category)
                    <!-- <div class="card1 mb-3"> -->
                    <!-- <div class="card1-header">{{ $category->name }}</div> -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="card @if(!$loop->last)mb-3 @endif">
                            <div class="card-header"><?= $i; ?> - <b>{{ $question->question_text }}</b></div>
